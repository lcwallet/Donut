<div id="site-header" class="site-header text-center">
    <div class="site-header-cover">
        ...
        <div class="site-header-entry">
            <?php if ( qa_opt( 'donut_banner_closable' ) ): ?>
                <div class="hide-btn-wrap">
                    <button title="<?php echo donut_lang_html( 'hide_this_banner' ) ?>" id="hide-site-header" type="button" class="close" data-dismiss="site-header-entry" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                </div>
            <?php endif ?>
                ...
                <div class="container visible-md visible-lg">
                    <div class="col-md-4 jumbo-box">
                        <div class="wrap">
                            ...
                            <div class="hint"> <?php echo qa_opt( 'donut_banner_div1_text' ) ?> </div>
                        </div>
                    </div> <!-- End of jumbo box-->
                    <div class="col-md-4 jumbo-box">
                        <div class="wrap">
                            <div class="icon-wrap">
                                <span class="<?php echo qa_opt( 'donut_banner_div2_icon' ) ?> large-icon"></span>
                            </div>
                            <div class="hint"> <?php echo qa_opt( 'donut_banner_div2_text' ) ?> </div>
                        </div>
                    </div> <!-- End of jumbo box-->
                    <div class="col-md-4 jumbo-box">
                        <div class="wrap">
                            ...
                            <div class="hint"> <?php echo qa_opt( 'donut_banner_div3_text' ) ?> </div>
                        </div>
                    </div> <!-- End of jumbo box-->
                    ...
                    <div class="search-bar col-lg-4 col-lg-push-4 col-md-6 col-md-push-3 col-sm-8 col-sm-push-2 col-xs-10 col-xs-push-1">
                        <form class="form-inline" method="post" action="<?php echo qa_path_html( 'ask' ); ?>">
                            <div class="form-group form-group-lg">
                                <input type="text" class="form-control input-lg ask-field" id="ask" placeholder="<?php echo donut_lang( 'ask_placeholder' )?>" name="title" />
                            </div>
        ...
        </div> <!-- End of site header entry -->
    </div> <!-- End of site header cover -->
